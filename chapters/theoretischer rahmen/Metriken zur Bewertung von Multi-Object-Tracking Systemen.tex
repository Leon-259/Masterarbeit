...
\subsection{Die CLEAR MOT Metriken} \label{MOT MOTA}
...
\subsection{Die Identifikationsmetrik: IDF1} \label{MOT F1}
...
\subsection{Higher Order Tracking Accuracy}  \label{MOT HOTA}
