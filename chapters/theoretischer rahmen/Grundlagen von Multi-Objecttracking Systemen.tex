\section{Grundlagen von Multi-Object Tracking Systemen} \label{sec:Grundlagen von MOT}
...
\end{itemize}
\todo{Abkürzungen einfügen FP TP}
\todo{Abkürzungen einfügen TP erwähnen für Abkürzung}
...
\todo{Weiter fehler aus der Lit.: IDSW [HOTA]}

Bei der \gls{Lokalisation} liegt der Fehler in der Abweichung von der genauen Position des Objekts \cite{Leichter.2013}. In der Abbildung \ref{fig:ErrorTypesMOT} sind die unterschiedlichen Fehlerarten illustriert. \todo{Bild fehlt}
