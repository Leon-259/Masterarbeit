...
\emptyFigure{Verlauf der \textit{HOTA}-Wertungen der Gesamtperformance der Assoziationsalgorithmen.}{fig:ErgebGesamtMOT}
\todo{Abbildung fehlt}
...
\emptyFigure{Vergleich der bounding Boxen der Ground Truth und des Detektionsmoduls.}{fig:GTvsDetsComp}
\todo{Abbildung fehlt}
...
\emptyFigure{Verlauf der \textit{HOTA}-Wertungen von SORT zu den unterschiedlichen Ereignissen.}{fig:SORTHOTAEREIG}
\todo{Abbildung fehlt}

\emptyFigure{Verlauf der \textit{HOTA}-Wertungen vom Crocker-Grier Linking Algorithmus zu den unterschiedlichen Ereignissen.}{fig:CROCKHOTAEreig}
\todo{Abbildung fehlt}
...
\emptyFigure{Darstellung der Laufzeiten der Assoziaitonsalgorithmen in Abhängigkeit der Ereignisdauer.}{fig:plotRunTMOT}
\todo{Abbildung fehlt}
