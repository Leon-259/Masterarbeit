...
\begin{itemize}
    \item \textit{Modularität}: Aus der Forderung nach \glsdisp{Modul}{Modularität} entsteht die Anforderung einer einfachen Integrierbarkeit in eine Datenverarbeitungskette.
