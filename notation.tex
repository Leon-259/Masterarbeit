...
\nomenclature[09]{\(\{a_1, a_2, \dots, a_n\}\)}{Definition einer Menge}
\nomenclature[10]{\(\lvert A \lvert\)}{Mächtigkeit einer Menge}
\nomenclature[11]{\(\emptyset\)}{Die leere Menge}
\nomenclature[12]{\([a;b]\)}{Definition eines Wertebereichs}
